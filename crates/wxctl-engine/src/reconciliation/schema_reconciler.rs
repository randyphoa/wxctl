    ...
    fn build_get_by_id_spec_interpolates_parent_scoped_path_fields() {
        ...
        let schema = ResourceSchema {
            resource: ResourceDefinition {
                ...
                reconciliation: ReconciliationDefinition {
                    discovery: DiscoveryDefinition { method: DiscoveryMethod::GetById, list_field: None, name_field: None, identity_match: None, absent_when: None, list_method: None, list_body: None, id_source: "name".into() },
                    identity_hash: None,
                    state_fields: Some(vec![]),
                    update_strategy: UpdateStrategy::Patch,
                    immutable_fields: vec![],
    ...
    fn make_connection_schema() -> ResourceSchema {
        ...
        ResourceSchema {
            resource: ResourceDefinition {
                ...
                reconciliation: ReconciliationDefinition {
                    discovery: DiscoveryDefinition { method: DiscoveryMethod::GetById, list_field: None, name_field: None, identity_match: None, absent_when: None, list_method: None, list_body: None, id_source: "app_id".into() },
                    identity_hash: None,
    ...
    fn make_env_marker_schema() -> ResourceSchema {
        ...
        ResourceSchema {
            resource: ResourceDefinition {
                ...
                schema: SchemaDefinition { fields: vec![], ..Default::default() },
                reconciliation: ReconciliationDefinition {
                    discovery: DiscoveryDefinition { method: DiscoveryMethod::ListAndGet, list_field: Some("results".into()), name_field: None, identity_match: None, absent_when: None, list_method: None, list_body: None, id_source: "id".into() },
    ...
    fn make_local_hash_schema() -> ResourceSchema {
        ...
        ResourceSchema {
            resource: ResourceDefinition {
                ...
                schema: SchemaDefinition { fields: vec![], ..Default::default() },
                reconciliation: ReconciliationDefinition {
                    discovery: DiscoveryDefinition { method: DiscoveryMethod::Skip, list_field: None, name_field: None, identity_match: None, absent_when: None, list_method: None, list_body: None, id_source: "id".into() },
    ...
    fn make_ingestion_job_schema() -> ResourceSchema {
        ...
        ResourceSchema {
            resource: ResourceDefinition {
                ...
                schema: SchemaDefinition { fields: vec![], ..Default::default() },
                reconciliation: ReconciliationDefinition {
                    discovery: DiscoveryDefinition { method: DiscoveryMethod::GetById, list_field: None, name_field: Some("id".into()), identity_match: None, absent_when: None, list_method: None, list_body: None, id_source: "id".into() },

...
pub const VALID_AUTH_TYPES: &[&str] = &["none", "apikey", "basic", "cp4d", "icp4d", "bearer", "c_api_key", "api_token", "hmac", "zenapikey", "pa_session"];
...
fn cred_fields(auth_type: &str) -> &'static [&'static str] {
    match auth_type {
        "apikey" | "bearer" | "c_api_key" | "api_token" | "pa_session" => &["apikey"],

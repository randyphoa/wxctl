...
use crate::output::panel_render::{ExecWidths, exec_marker_action_label, id_slot_reserve, render_changes, render_errors, render_exec_footer, render_execution, render_footer};
...
pub struct OutputCollector {
    ...
    /// document is the only stdout. State collection is unaffected.
    quiet: bool,
}
...
impl OutputCollector {
    ...
    /// Enter quiet (machine-readable) mode. Must be set before any render call.

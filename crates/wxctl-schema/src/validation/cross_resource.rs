    ...
    fn make_descriptor(kind: &str) -> Arc<ResourceDescriptor> {
        let schema = ResourceSchema {
            resource: ResourceDefinition {
                ...
                kind: kind.into(),
                version: "v1".into(),
                api: ApiDefinition { base_path: "/x".into(), id_field: "id".into(), list_endpoint: None, get_endpoint: "/x/{id}".into(), create_endpoint: None, create_method: HttpMethod::Post, update_endpoint: None, update_method: None, delete_endpoint: None, delete_method: HttpMethod::Delete },

...
mod tests {
    ...
    fn field_ref(name: &str, target: &str, require_ready: bool) -> FieldDefinition {
        FieldDefinition {
            ...
            default: None,
            allowed_values: None,
            references: Some(FieldReferences { resource: target.into(), field: "id".into(), also_allows: vec![], optional: false, require_ready, relationship: None }),
            api_field: None,
            sensitive: false,
            also_query: false,
            properties: None,
        ...
        ResourceSchema {
            resource: ResourceDefinition {
                ...
                reconciliation: ReconciliationDefinition {
                    discovery: DiscoveryDefinition { method: DiscoveryMethod::ListAndGet, list_field: None, name_field: None, identity_match: None, absent_when: None, list_method: None, list_body: None, list_map: false, list_filter: None, id_source: "id".into() },
                    state_fields: None,

...
input_schema:
  ...
  properties:
    time_period:
      type: string
      description: Time period to query (e.g., "Q1 2024", "last 30 days")
  required:
    - time_period
...
input_schema:
  ...
  properties:
    compare_dimension:
      type: string
      description: What to compare (e.g., "reps", "regions", "time periods")
    time_range:
      type: string
      description: Time range for comparison (e.g., "Q2 vs Q3", "last 6 months")
  required:
    - compare_dimension
    - time_range
